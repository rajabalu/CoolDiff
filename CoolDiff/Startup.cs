...
using CoolDiff.Authorization;
using CoolDiff.Helpers;
using CoolDiff.ViewModels;
...
namespace CoolDiff
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("CoolDiff"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "CoolDiff API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ILogger<Startup> logger, IDatabaseInitializer databaseInitializer)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CoolDiff API V1");
            });
